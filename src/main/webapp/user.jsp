            ...
            <div class="card-body p-5">
              ...
              <form action="userlogin" method="post">
                ...
                <div class="form-outline mb-3 d-flex justify-content-center">
                  <input type="email" id="form3Example3cg" class="form-control-lg vw-100" placeholder="Enter Your UserId" name="user"/>
                </div>
               ...
               <p>If Not Registered Please ?  <a href="user-register.jsp"><u>New Registration</u></a></p>
              </form>
